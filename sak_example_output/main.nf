...
params.bed2interval_input_bed = "./sak_data/*.bed"
...
workflow {
    ...
    */
    ...
    BED2INTERVAL_UpStream = Channel.fromPath("$baseDir" + "/data/upstream_sanitychk")
    ...
    if (params.bed2interval_dockerimg) {
        BED2INTERVALDOC(BED2INTERVAL_bed,BED2INTERVAL_dict, BED2INTERVAL_UpStream, BED2INTERVAL_ScriptFiles, params.bed2interval_argument, params.bed2interval_dockerimg, params.bed2interval_sakcpu, params.bed2interval_sakmem, params.bed2interval_saktime, params.bed2interval_outputDir)
    } else {
        BED2INTERVAL(BED2INTERVAL_bed,BED2INTERVAL_dict, BED2INTERVAL_UpStream, BED2INTERVAL_ScriptFiles, params.bed2interval_argument, params.bed2interval_sakcpu, params.bed2interval_sakmem, params.bed2interval_saktime, params.bed2interval_outputDir)   
    }
    //* ## step cmd example SAK
    ...
    ADDCHR_UpStream = Channel.fromPath("$baseDir" + "/data/upstream_sanitychk").concat(BED2INTERVALDOC.out.file)|collect
    ...
    if (params.addchr_dockerimg) {
        ADDCHRDOC(ADDCHR_file, ADDCHR_UpStream, ADDCHR_ScriptFiles, params.addchr_argument, params.addchr_dockerimg, params.addchr_sakcpu, params.addchr_sakmem, params.addchr_saktime, params.addchr_outputDir)
    } else {
        ADDCHR(ADDCHR_file, ADDCHR_UpStream, ADDCHR_ScriptFiles, params.addchr_argument, params.addchr_sakcpu, params.addchr_sakmem, params.addchr_saktime, params.addchr_outputDir)   
    }
